...
plot_align <- function(in_dat, out_name){
 ...
 if(length(params$donor_ag) == 1){
  ...
  short1_2nd <- allele_info %>%
   ...
   plot_align(in_dat = for_align1, out_name = "align1.pdf")
   plot_align(in_dat = short1_1st, out_name = "align1_1st.pdf")
   plot_align(in_dat = short1_2nd, out_name = "align1_2nd.pdf")
 }
 ...
 if(length(params$donor_ag) == 2){
   ...
   plot_align(in_dat = for_align2, out_name = "align2.pdf")
   plot_align(in_dat = short2_1st, out_name = "align2_1st.pdf")
   plot_align(in_dat = short2_2nd, out_name = "align2_2nd.pdf")
 }
...
### sequence alignment
#### allele 1
```{r msa-align1, , eval = align_plot, echo=FALSE, include=TRUE, fig.align="center", out.width="90%"}
knitr::include_graphics(path="align1.pdf")
```

```{r msa-align1_1st, , eval = align_plot, echo=FALSE, include=TRUE, fig.align="center", out.width="90%"}
knitr::include_graphics(path="align1_1st.pdf")
```

```{r msa-align1_2nd, , eval = align_plot, echo=FALSE, include=TRUE, fig.align="center", out.width="90%"}
knitr::include_graphics(path="align1_2nd.pdf")
```

#### allele 2
```{r msa-align2, , eval = align_plot, echo=FALSE, include=TRUE, fig.align="center", out.width="90%"}
if(length(params$donor_ag) == 2){
knitr::include_graphics(path="align2.pdf")
}
```

```{r msa-align2_1st, , eval = align_plot, echo=FALSE, include=TRUE, fig.align="center", out.width="90%"}
if(length(params$donor_ag) == 2){
knitr::include_graphics(path="align2_1st.pdf")
}
```

```{r msa-align2_2nd, , eval = align_plot, echo=FALSE, include=TRUE, fig.align="center", out.width="90%"}
if(length(params$donor_ag) == 2){
knitr::include_graphics(path="align2_2nd.pdf")
}
```

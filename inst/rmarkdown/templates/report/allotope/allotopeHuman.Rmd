...
The allele lists and amino acid sequences used in this package were downloaded from [IPD_IMGT-HLA](https://www.ebi.ac.uk/ipd/imgt/hla/) website on `date` - or we give version ( 10/2021 ?). A description of can be found at [HLA nomenclature](http://hla.alleles.org/nomenclature/index.html). The prediction function used in *allotopeR* is performed via the API to the [Immune epitope database](https://www.iedb.org).
